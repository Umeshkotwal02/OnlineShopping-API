            ...
            <div className="container fluid">
                <div className="row g-4">
                    <div className="col-12 col-md-6">
                        <Link
                            to={`/products-page?category=${data?.banners[3]?.category_id}`}
                    ...
                    <div className="col-12 col-md-6">
                        <div className="row g-3">
                            <div className="col-12">
                                <Link
                                    to={`/products-page?category=${data?.banners[0]?.category_id}`}
                                    className="d-block h-100 overflow-hidden"
                                >
                                    <img
                            ...
                            <div className="col-6">
                                <Link
                                    to={`/products-page?category=${data?.banners[1]?.category_id}`}
                                    className="d-block h-100 overflow-hidden"
                                >
                                    <img
                            ...
                            <div className="col-6">
                                <Link
                                    to={`/products-page?category=${data?.banners[2]?.category_id}`}
                                    className="d-block h-100 overflow-hidden"
                                >
                                    <img
